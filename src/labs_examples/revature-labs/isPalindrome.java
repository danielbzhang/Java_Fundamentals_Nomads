...
public class isPalindrome {
   ...
   * You could start with a String reversal algorithm, which you have already
   * written, and check if str is the same
   * as its reversed form, or, you could check if the character at the nth
   * position of a String moving forwards
